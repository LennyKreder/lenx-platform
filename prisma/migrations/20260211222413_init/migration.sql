...
CREATE TABLE "producttemplate" (
    ...
    "isDated" BOOLEAN NOT NULL DEFAULT true,
    "startYear" INTEGER,
    "contentLanguages" TEXT[],
    "themeSelection" VARCHAR(10) NOT NULL DEFAULT 'all',
    "selectedThemes" TEXT[],
    "sortOrder" INTEGER NOT NULL DEFAULT 0,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "review_translation" (
    ...
    CONSTRAINT "review_translation_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "product_contentLanguage_idx" ON "product"("contentLanguage");

-- CreateIndex
CREATE INDEX "product_productType_idx" ON "product"("productType");

-- CreateIndex
CREATE INDEX "product_device_idx" ON "product"("device");
...
-- CreateIndex
CREATE INDEX "review_translation_reviewId_idx" ON "review_translation"("reviewId");

-- CreateIndex
CREATE UNIQUE INDEX "review_translation_reviewId_languageCode_key" ON "review_translation"("reviewId", "languageCode");
...
-- CreateIndex
CREATE INDEX "discount_targetDevice_idx" ON "discount"("targetDevice");

-- CreateIndex
CREATE INDEX "discount_targetTemplateId_idx" ON "discount"("targetTemplateId");
...
-- CreateIndex
CREATE INDEX "discountcode_targetDevice_idx" ON "discountcode"("targetDevice");

-- CreateIndex
CREATE INDEX "discountcode_targetTemplateId_idx" ON "discountcode"("targetTemplateId");
...
-- CreateIndex
CREATE UNIQUE INDEX "contentpagetranslation_pageId_languageCode_key" ON "contentpagetranslation"("pageId", "languageCode");
...
-- CreateIndex
CREATE UNIQUE INDEX "blogposttranslation_postId_languageCode_key" ON "blogposttranslation"("postId", "languageCode");
...
-- AddForeignKey
ALTER TABLE "review_translation" ADD CONSTRAINT "review_translation_reviewId_fkey" FOREIGN KEY ("reviewId") REFERENCES "review"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "discount" ADD CONSTRAINT "discount_targetTemplateId_fkey" FOREIGN KEY ("targetTemplateId") REFERENCES "producttemplate"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "discountcode" ADD CONSTRAINT "discountcode_targetTemplateId_fkey" FOREIGN KEY ("targetTemplateId") REFERENCES "producttemplate"("id") ON DELETE SET NULL ON UPDATE CASCADE;
